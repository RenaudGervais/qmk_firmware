...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(
        ...
        KC_LALT,          KC_LGUI, KC_LCTL, KC_SPC ,          KC_SPC ,          KC_SPC , MO(1)  , MO(2)  , XXXXXXX, KC_RGUI,          KC_RCTL),
    ...
    KEYMAP(
        ...
        _______,          KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_DEL , _______, _______, _______, _______, _______, _______,          _______,
